...
// ============aсинхронный axios =======================
const fetchGallery = async (key, pageNumber, searchQuery) => {
    try {
        const response = await axios.get(`https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=${searchQuery}&page=${pageNumber}&per_page=12&key=${key}`);
